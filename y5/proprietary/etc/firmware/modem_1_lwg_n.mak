...
# Generated at 2016-06-22 21:60:40

PMIC_VRF18_VOLTAGE_FINE_TUNE = TRUE     # Value:TRUE
                                        # Description:FINE TUNE VRF18 ENABLE
                                        # Value:FALSE
                                        # Description:FINE TUNE VRF18 DISABLE


IMS_OTA_MESSAGE_SUPPORT = FALSE     # Value:TRUE
                                    # Description:Enable this function in MD load then ELT can show send/recv SIP messages in ELT
                                    # Value:FALSE
                                    # Description:Disable this function in MD load then ELT can't show send/recv SIP messages in ELT
...
RF_MODULE = MT6735_2G_MT6169_CUSTOM_MAYA_L22
  # Description:
...
LTE_RF_MODULE = MT6735_LTE_MT6169_CUSTOM_MAYA_L22
  # Description:
...
UMTS_RF_MODULE = MT6735_UMTS_FDD_MT6169_CUSTOM_MAYA_L22
  # Description:
...
# ------------------------------ Verno information
VERNO = MOLY.LR9.W1444.MD.LWTG.MP.V94.P66
BUILD = BUILD_NO
...
HQ_SML_LOCK_SUPPORT = TRUE
HQ_MAYA_AMRWB_2G_CLOSE = TRUE
HQ_MAYA_AMRWB_4G_CLOSE = TRUE
#==============
...
PROJECT_MAKEFILE_EXT = HQ6737T_66_1HA_M0(LWG_DSDS_COTSX)_EXT_MAYA_L22
#
#  Copyright Statement:
#  ---------------------------
#  This software/firmware and related documentation ("MediaTek Software") are
...
MM_RF_MODULE = MT6735_MMRF_CUSTOM_MAYA_L22
  # Description:
...
#[MTK internal used]# ------------------------------ 
ORIGINAL_VERNO = MOLY.LR9.W1444.MD.LWTG.MP.V94.P66
...
ORIGINAL_PROJECT_NAME = HQ6737T_66_1HA_M0
  # Description:
...
VM_CODEC = TRUE
#DTS2016122201796  chengbin/wx316492 20161222 begin
HQ_MAYA_AMRWB_2G_CLOSE = TRUE
HQ_MAYA_AMRWB_3G_CLOSE = TRUE
HQ_MAYA_AMRWB_4G_CLOSE = TRUE
#DTS2016122201796  chengbin/wx316492 20161222 end
...
############################################################
COM_DEFS_FOR_MT6735_LTE_MT6169_CUSTOM_MAYA_L22  = MT6169_RF MT6169_LTE_RF MT6735_LTE_MT6169_CUSTOM_MAYA_L22
COM_DEFS_FOR_MT6735_2G_MT6169_CUSTOM_MAYA_L22   = MT6169_2G_RF  MT6735_2G_MT6169_CUSTOM_MAYA_L22
COM_DEFS_FOR_MT6735_UMTS_FDD_MT6169_CUSTOM_MAYA_L22  = MT6169_RF MT6169_UMTS_FDD MT6735_UMTS_FDD_MT6169_CUSTOM_MAYA_L22
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
...
CUSTOM_OPTION += __VSIM__ __EARLY_REPORT_PS_REG_STATUS__
CUSTOM_OPTION += __L1DMA_DFEDMA_WORKAROUND__
CUSTOM_OPTION += __AT_EPBW_SUPPORT__ __MULTIPLE_VERIFY_ALLOW__
CUSTOM_OPTION += __ARA_FOR_CELL_SELECTION__
# DTS2016111502557 wangrupeng/wwx387125 20161115 begin
CUSTOM_OPTION += __SDM_TRY_CS_WHEN_2G_VOICE_CALL__
# DTS2016111502557 wangrupeng/wwx387125 20161115 end
CUSTOM_OPTION += __SUBADDR_SUPPORT__
CUSTOM_OPTION += __NAS_AS_ALL_ZERO_ACC_MODIFY__
#DTS2017032105799 zhuqi/wx387117 20170322 begin
#DTS2016121504721  chengbin/wx316492 20161215 begin
#CUSTOM_OPTION += __VDP_SET_CS_VOICE_ONLY__
#DTS2016121504721  chengbin/wx316492 20161215 end
#DTS2017032105799 zhuqi/wx387117 20170322 end
CUSTOM_OPTION += __A5_3_AND_GEA_WHILTE_LIST__ __SIM_SEARCH_RECORD_SUPPORT__
CUSTOM_OPTION += __VOLTE_CONFIG_BY_IMS__
CUSTOM_OPTION += __ME_STORED_EHPLMN__
CUSTOM_OPTION += __RF_TEST_TX_REPORT__
CUSTOM_OPTION += __R11_CELL_FACH_LTE_APBCR__
...
#DTS2017032105799 zhuqi/wx387117 20170322 begin
# *******************************************************************************************************
# default:CUSTOM_OPTION += __VDP_SET_CS_VOICE_ONLY__ ,when VDP_SET_CS_VOICE_CLOSE = TRUE ,close cs voice
# *******************************************************************************************************
ifeq ($(strip $(VDP_SET_CS_VOICE_CLOSE)),TRUE)
#CUSTOM_OPTION += __VDP_SET_CS_VOICE_ONLY__
else
CUSTOM_OPTION += __VDP_SET_CS_VOICE_ONLY__
endif
